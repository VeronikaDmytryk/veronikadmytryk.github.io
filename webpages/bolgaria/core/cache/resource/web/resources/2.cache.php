...
Переезд в Болгарию.',
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1493239379,
    'editedby' => 1,
    'editedon' => 1494867359,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1494867359,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<li class="last"><a href="move" title="Недвижимость и переезд" >Недвижимость и переезд</a></li>
		...
		<!--</ul>-->
			...
			<div class="container">
				<div class="header__subtitle text-center">Контакты
				</div>
				<a href="#contacts" class="header__arrow_small">
					<i  class="fa fa-angle-down"></i>
				</a>
			</div>
		</header>
		<section class="greybackground" id="contacts">
			<div class="container">
			<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="contacts__block">
						<h3 class="contacts__text text-center">Мы всегда на связи и ответим на все интересующие Вас вопросы!</h3>
						<div class="row">
									...
									<div class="col-md-10 col-md-offset-1 col-sm-12 col-sm-offset-0 col-xs-8 col-xs-offset-2">
										<ul class="contacts__list">
											<li class="contacts__item">
												<div class="contacts__icon pull-left"></div>
												<h3 class="contacts__item_title">Телефоны</h3>
												<p class="contacts__item_text">В Болгарии <span>+8 (123) 12-123-123</span><br>В России <span>+7 (495) 12-321-345</span></p>
											</li>
											<li class="contacts__item">
												<div class="contacts__icon pull-left"></div>
												<h3 class="contacts__item_title">E-mail</h3>
												<a href="info@sitename.ru" class="contacts__item_text">info@sitename.ru</a>
											</li>
											<li class="contacts__item">
												<div class="contacts__icon pull-left"></div>
												<h3 class="contacts__item_title">Skype</h3>
												<a href="skype.com" class="contacts__item_text">compasscompany</a>
											</li>
										</ul>
									</div>
								</div>
							...
							<div class="col-md-6 col-sm-6 col-xs-12 text-center">
								<div class="row">
									<div class="col-md-10">
										<div class="contact contacts__form">
											<h2 class="contacts__title">Есть вопросы<br><span>по переезду в болгарию?</span></h2>
											<div class="row">
												<div class="col-md-10 col-md-offset-1 col-xs-10 col-xs-offset-1">
													<div class="contacts__slogan">Мы проконсультируем Вас бесплатно!</div>
...
<li class="last"><a href="move" title="Недвижимость и переезд" >Недвижимость и переезд</a></li>
    ...
    '[[*longtitle]]' => 'Контакты',
    '[[*phone_bolgaria]]' => '+8 (123) 12-123-123',
    '[[*email]]' => 'info@sitename.ru',
    '[[*skype]]' => 'compasscompany',
    '[[$FOOTER]]' => '<footer>
	<div class="container">
		<div class="row">
			<div class="col-md-3 col-sm-4 col-xs-4">
